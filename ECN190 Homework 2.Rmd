...
<<<<<<< HEAD
USeconomy %>% ggplot(aes(x = t, y = gdpgrowth)) + geom_line() + theme_bw() + theme(legend.position = "none") + 
  scale_color_manual(values = c("red3", "black")) + geom_smooth(method = "lm", formula = "y~x", se = F)  + scale_x_continuous("Time")
=======
USeconomy %>% ggplot(aes(x = t, y = gdpgrowth)) + geom_line() + theme_bw() + 
  ...
  scale_color_manual(values = c("red3", "black")) + geom_smooth(method = "lm", 
                                                                formula = "y~x", 
                                                                se = F) 
>>>>>>> dc42dba4ad1f16609408a84ab09061707fe9633a
```

...
## 1. Obtain time series data about the U.S. ecnomony and summarize. 
...
According to the joint significance hypothesis test on all variables other than t, the additional.variables are not significant because the p-value (0.7767) indicates that the F-test is not significant at any reasonable level of alpha.
